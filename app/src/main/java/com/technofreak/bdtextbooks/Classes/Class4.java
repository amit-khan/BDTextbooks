...
public class Class4 extends AppCompatActivity {
    private static String [] file_url = {
            "https://drive.google.com/uc?export=download&id=0B8L6VJQZe3EENF9ObXRNZ21KU3c",
            "https://drive.google.com/uc?export=download&id=0B8L6VJQZe3EEdzNSQURLSUZkRDg",
            "https://drive.google.com/uc?export=download&id=0B8L6VJQZe3EEVE9ibEVpNXZjTGs",
            "https://drive.google.com/uc?export=download&id=0B8L6VJQZe3EEMmMyamhSVGNvMDQ",
            "https://drive.google.com/uc?export=download&id=0B8L6VJQZe3EEbXZERVZ0TXF2TkE",
            "https://drive.google.com/uc?export=download&id=0B8L6VJQZe3EEMUJXLXNyMUE4QlE" };
    ...
    private class DownloadFileFromURL extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                if (fileNo==0) {
                    output = new FileOutputStream(appDir + "/ban_4.pdf");
                } else if (fileNo==1){
                    output = new FileOutputStream(appDir + "/mat_4.pdf");
                }else if (fileNo==2){
                    output = new FileOutputStream(appDir + "/eng_4.pdf");
                }else if (fileNo==3){
                    output = new FileOutputStream(appDir + "/isl_4.pdf");
                }else if (fileNo==4){
                    output = new FileOutputStream(appDir + "/hin_4.pdf");
                }else if (fileNo==5){
                    output = new FileOutputStream(appDir + "/sci_4.pdf");
                }
    ...
    public void ban(View view) {
        File f = new File(appDir + "/ban_4.pdf");
        if (f.exists()){
            open(f);
        }else {
            fileNo=0;
    ...
    public void mat(View view) {
        File f = new File(appDir + "/mat_4.pdf");
        if (f.exists()){
            open(f);
        }else {
            fileNo=1;
    ...
    public void eng(View view) {
        File f = new File(appDir + "/eng_4.pdf");
        if (f.exists()){
            open(f);
        }else {
            fileNo=2;
    ...
    public void islam(View view) {
        File f = new File(appDir + "/isl_4.pdf");
        if (f.exists()){
            open(f);
        }else {
            fileNo=3;
    ...
    public void hindu(View view) {
        File f = new File(appDir + "/hin_4.pdf");
        if (f.exists()){
            open(f);
        }else {
            fileNo=4;
    ...
    public void sci(View view) {
        File f = new File(appDir + "/sci_4.pdf");
        if (f.exists()){
            open(f);
        }else {
            fileNo=5;
