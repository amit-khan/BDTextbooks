...
public class Class8 extends AppCompatActivity {
    ...
    private static String [] file_url = {
            "https://drive.google.com/uc?export=download&id=0B8L6VJQZe3EERFpYaWRRZUVBSTg",
            "https://drive.google.com/uc?export=download&id=0B0EXISX1gyucSDhjd056dVFRZEk",
            "https://drive.google.com/uc?export=download&id=0B0EXISX1gyucMjdTa05uV0U5Zjg",
            "https://drive.google.com/uc?export=download&id=0B0EXISX1gyucYzVPQWxlMzluc00",
            "https://drive.google.com/uc?export=download&id=0B0EXISX1gyucMWVENTA0dnN1NTg",
            "https://drive.google.com/uc?export=download&id=0B8L6VJQZe3EET3hKSUJqelE5LUk",
            "https://drive.google.com/uc?export=download&id=0B8L6VJQZe3EEcURiWGdDRjd2NXc" };
    private int fileNo;
    ...
    private class DownloadFileFromURL extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                if (fileNo==0) {
                    output = new FileOutputStream(appDir + "/ban1_8.pdf");
                } else if (fileNo==1){
                    output = new FileOutputStream(appDir + "/mat_8.pdf");
                }else if (fileNo==2){
                    output = new FileOutputStream(appDir + "/eng_8.pdf");
                }else if (fileNo==3){
                    output = new FileOutputStream(appDir + "/isl_8.pdf");
                }else if (fileNo==4){
                    output = new FileOutputStream(appDir + "/sci_8.pdf");
                }else if (fileNo==5){
                    output = new FileOutputStream(appDir + "/ban2_8.pdf");
                }else if (fileNo==6){
                    output = new FileOutputStream(appDir + "/info_8.pdf");
                }
    ...
    public void ban1(View view) {
        File f = new File(appDir + "/ban1_8.pdf");
        if (f.exists()){
            open(f);
        }else {
            fileNo=0;
    ...
    public void mat(View view) {
        File f = new File(appDir + "/mat_8.pdf");
        if (f.exists()){
            open(f);
        }else {
            fileNo=1;
    ...
    public void eng(View view) {
        File f = new File(appDir + "/eng_8.pdf");
        if (f.exists()){
            open(f);
        }else {
            fileNo=2;
    ...
    public void islam(View view) {
        File f = new File(appDir + "/isl_8.pdf");
        if (f.exists()){
            open(f);
        }else {
            fileNo=3;
    ...
    public void sci(View view) {
        File f = new File(appDir + "/sci_8.pdf");
        if (f.exists()){
            open(f);
        }else {
            fileNo=4;
    ...
    public void ban2(View view) {
        File f = new File(appDir + "/ban2_8.pdf");
        if (f.exists()){
            open(f);
        }else {
            fileNo=5;
    ...
    public void info(View view) {
        File f = new File(appDir + "/info_8.pdf");
        if (f.exists()){
            open(f);
        }else {
            fileNo=6;
